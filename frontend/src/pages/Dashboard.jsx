...
const styles = {
  ...
  statVal: { fontSize: 20, fontWeight: 500, letterSpacing: -0.5 },
  statSub: {
    fontSize: 11,
    color: "rgba(250,250,250,0.28)",
    marginTop: 3,
...
export default function Dashboard() {
  ...
  const totalSpent = transactions.reduce(
    (s, t) => s + (t.status === "success" ? Number(t.amount) : 0),
    0,
  );
          ...
          >
            <div>
              ...
              <div style={styles.balAmt}>
                ...
                {wallet?.balance != null ? Number(wallet.balance).toLocaleString('en-NG', { minimumFractionDigits: 2 }) : 'Loading...'}
              </div>
            </div>
        ...
        <div style={styles.stats}>
          ...
          <div style={styles.stat}>
            ...
            <div style={styles.statSub}>
              {successCount} of {transactions.length} ok
            </div>
          </div>
          <div style={styles.stat}>
            <div style={styles.statVal}>
              {SERVICES.filter((s) => s.live).length} live
            </div>
            <div style={styles.statSub}>
              {SERVICES.filter((s) => !s.live).length} coming soon
            </div>
          </div>
        </div>
              ...
              <>
                <div style={{ ...styles.svcIco, background: svc.bg }}>
                  <i
                    ...
                    style={{ fontSize: 20, color: svc.color }}
                    aria-hidden="true"
                  />
                </div>
